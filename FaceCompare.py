...
# You will need to change the path below. If it's within the same place it can just be the file name eg. load_image_file("Taylor_swift1.jpg")
...
# You will need to change the below path.
